...
>
ZotFile doesn't work with Zotero 7. 
Instead, I now use [ZotMoov](https://github.com/wileyyugioh/zotmoov) to move attached files to a custom directory (with custom subfolders too).
