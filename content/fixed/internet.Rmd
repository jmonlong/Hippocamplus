...
I rarely need to manage/explore my library on my Android device (I usually just sync then read/annotate the most recent PDFs), but when I do I use the [ZotDroid](https://play.google.com/store/apps/details?id=computer.benjamin.zotdr0id&hl=en_US) app, or the [Library](https://play.google.com/store/apps/details?id=com.cgogolin.library&hl=en_US&gl=US) app to search my library's BibTeX file (also synced).
