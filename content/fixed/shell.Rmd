...
- `alias terml='gnome-terminal --tab-with-profile="Sol Light" && exit'` to open a new terminal with light theme (and close the current one).
- `alias termd='gnome-terminal --tab-with-profile="Sol Dark" && exit'` same with dark theme (and close the current one).
