...
I [tweaked](https://stat.ethz.ch/pipermail/ess-help/2004-September/002092.html) a function to run `rmarkdown::render` on the current buffer and bound it to `C-c C-r`.
...
(add-hook 'markdown-mode-hook
          (lambda ()
            (local-set-key (kbd "C-c C-r") 'renderRmd)))
