...
I'll try different methods such as hierarchical clustering, K-means, Guassian mixture, density-based clustering and Louvain community detection.
...
PS: I added the resolution parameter `gamma` in the *igraph* function for the Louvain clustering. It was easy to change in the C code. Compiling *igraph* from source, however, is a pain and I couldn't get it to work on OSX. I managed to install this modified version of igraph on Linux following [these instructions](https://github.com/jmonlong/Hippocamplus/tree/config/R/rigraph_gammalouvain).
