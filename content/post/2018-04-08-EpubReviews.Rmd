...
Third post on the series of *"Things I did instead of writing my thesis to help me write my thesis"*: how to find/convert reviews in the EPUB format to read in a ebook reader.
...
An exception: the **"*Opportunities and obstacles for deep learning in biology and medicine*"**, a cool (and long) review which was published in [the Journal of the Royal Society Interface](http://rsif.royalsocietypublishing.org/content/15/141/20170387), is also formatted in [a GitHub HTML page](https://greenelab.github.io/deep-review/).
...
Some reviews or articles are part of collections, like the "Point of significance" serie in Nature Methods. 
...
I don't think I'm allowed to share publicly the **"Point of Significance" EPUB** but I can share the commands I used so I put [the instructions on GitHub](https://github.com/jmonlong/Hippocamplus/tree/config/R/epubifyReviews).
...
- Most of the time, tables are not converted properly by Pandoc, they appear flattened.
