...
*20 March 2019 Edit: I switched to Zotero (yeay open-source, bye Elsevier), using Google Drive to store the PDF files. See the [Internet section](/internet#zotero) and [the blog post that inspired the change](https://ikashnitsky.github.io/2019/zotero/).*
